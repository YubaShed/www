...
$databases = array (
  ...
  array (
    ...
    array (
      ...
      //'database' => '/home/yubashed/dev/db/drupal_sqlite_yuba',
'database' => '/var/www/html/db/drupal_sqlite_yuba',      
'driver' => 'sqlite',
         'prefix' => array(
      'default'   => '',
      'users'     => 'shared',
...
$databases['import']['import'] = array (
  //'database' => '/home/yubashed/dev/db/yubashed_import',
  'database' => '/var/www/html/db/yubashed_import',
    'driver' => 'sqlite',
      'prefix' => '',
      );
 ...
 *
 */
$drupal_hash_salt = 'xD3UtEgSn9fJvQrRLck0QUgha1AtS25STxfKDywjOUM';
