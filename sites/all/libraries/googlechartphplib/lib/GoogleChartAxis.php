...
class GoogleChartAxis
{
	...
	public function setRange2($start_val, $end_val, $step = false)
	{
		$this->range2 = array(
				'start_val' => $start_val === null ? 0 : $start_val,
				'end_val' => $end_val === null ? 100 : $end_val,
	...
	public function isRange2()
	{
		return $this->range2 !== null;
	}
	...
	public function getRange2($compute = true)
	{
		if ( ! $compute )
			return $this->range2;
		...
		$str = '%d,'.$this->range2['start_val'].','.$this->range2['end_val'];
		if ( $this->range2['step'] !== false )
			$str .= ','.$this->range2['step'];
	 ...
	 * @c chxp
	 */
	public function setLabelPositions($labelPositions)
	{
